...
public class cashier extends javax.swing.JFrame {
 ...
 jButton_delete.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Cashier", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 20))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try{
        String sql = "INSERT INTO cashier(username, password, status) VALUES (?,?,?)";
       conn = DriverManager.getConnection("jdbc:mysql://localhost/superpos?useUnicode=true&useJDBCCompliantTimezoneShift=tr"
               + "ue&useLegacyDatetimeCode=false&serverTimezone=UTC","dev","123");
       ps = conn.prepareStatement(sql);
       ps.setString(1, jTextField_username.getText());
       ps.setString(2, jPasswordField1.getText());
       ps.setString(3, jComboBox_status.getSelectedItem().toString());
       ps.executeUpdate();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField_username.setText(d1.getValueAt(selectedIndex, 1).toString());
    ...
    private void jButton_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_editActionPerformed
        ...
        String brand = jTextField_username.getText();
        String status = jComboBox_status.getSelectedItem().toString();
        
        try{
        String sql = "UPDATE brand SET cashier=? , status=? where id=?";
